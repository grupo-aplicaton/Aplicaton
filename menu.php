  ...
  <div class="container">
    <div class="row justify-content-between mt-5">
      ...
      <div class="col-auto align-self-center">
        ...
        <form action="" class="opciones-menu jumbotron mt-3">
          <fieldset class="borde-menu">
            <legend>Seleccione Opcion</legend>
             <div class="row justify-content-center ">
                 <div class="form-group col-12 col-md-4">
                   <button class="btn btn-primary col boton-menu">Categoria</button>
                 </div>

                 <div class="form-group col-12 col-md-4 ">
                   <button class="btn btn-primary col boton-menu">Sub-Categoria</button>
                 </div>
                 <div class="form-group col-12 col-md-4">
                   <button class="btn btn-primary col boton-menu">Acciones</button>
                 </div>
                 <div class="w-100"></div>
                 <div class="form-group col-12 col-md-4">
